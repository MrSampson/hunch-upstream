...
This repo has **Hunch** — a curated graph of *why* the code is the way it is (decisions, bug history, invariants). It currently holds **327 decisions, 2 bugs, 31 constraints, 22 components, 3 policies, 11 open findings**.
