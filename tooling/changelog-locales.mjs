export const changelogLocales = {
  he: {
    ...
    ui: {
      pageTitle: "יומן השינויים של Hunch — גרסאות ויכולות עדכניות", pageDescription: "כל גרסאות Hunch — זיכרון הנדסי, מצב דטרמיניסטי משותף, אינטגרציות ואימותי ייצור.",
      ...
      eyebrow: "יומן שינויים · החדש ביותר תחילה", heading: "כל גרסה, מאז <em>v0.1</em>.", intro: "מזיכרון הנדסי שנשמר ב-Git ועד מצב דטרמיניסטי משותף — כל הדרך, מהחדש לישן.",
  ...
  ru: {
    ...
    ui: {
      pageTitle: "История изменений Hunch — выпуски и текущие возможности", pageDescription: "Все выпуски Hunch: инженерная память, общее детерминированное состояние, интеграции и производственная проверка.",
      ...
      eyebrow: "история изменений · сначала новые", heading: "Все выпуски, начиная с <em>v0.1</em>.", intro: "От инженерной памяти в Git до общего детерминированного состояния — вся история, от новых выпусков к старым.",
  ...
  ar: {
    ...
    ui: {
      pageTitle: "سجل تغييرات Hunch — الإصدارات والقدرات الحالية", pageDescription: "كل إصدارات Hunch: الذاكرة الهندسية والحالة الحتمية المشتركة والتكاملات والتحقق للإنتاج.",
      ...
      eyebrow: "سجل التغييرات · الأحدث أولاً", heading: "كل إصدار، منذ <em>v0.1</em>.", intro: "من ذاكرة هندسية محفوظة في Git إلى حالة حتمية مشتركة — الرحلة كاملة، من الأحدث إلى الأقدم.",
  ...
  es: {
    ...
    ui: {
      pageTitle: "Registro de cambios de Hunch — versiones y capacidades actuales", pageDescription: "Todas las versiones de Hunch: memoria de ingeniería, estado determinista compartido, integraciones y validación para producción.",
      ...
      eyebrow: "registro de cambios · lo más reciente primero", heading: "Cada versión, desde <em>v0.1</em>.", intro: "De la memoria de ingeniería en Git al estado determinista compartido: toda la historia, de lo nuevo a lo antiguo.",
